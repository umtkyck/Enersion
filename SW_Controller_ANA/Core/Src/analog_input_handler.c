...
/* ADC not configured yet - using stub implementation */
...
{
    /* Note: This is a STUB implementation until ADC is configured in STM32CubeMX
    ...
    /* STUB: Comment out real ADC code until configured */
    // HAL_ADC_Start(&hadc1);
