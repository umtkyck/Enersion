...
Additionally we implement post processing of the samples in software.
The purpose is to average the signal and to reduce noise
...
namespace config {
  const char *Program = "sample_and_average";
  const char *Version = "2023-11-15";
...
double volt;
uint32_t t0 = 0;
AdaptiveMovingAverage avg(-10, 10);
